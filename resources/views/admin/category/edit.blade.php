                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h1>Edit Category</h1>
                                <a class="btn btn-sm btn-success" href="{{ url('admin/category/list') }}">Category Lists</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body p-3">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $getRecord->name) }}" placeholder="Category Name" class="form-control mt-2">
                                    </div>

                                    <div class="form-group mb-2">
                                        <label for="name">Slug <span class="text-danger">*</span></label>
                                        <input type="text" name="slug" value="{{ old('slug', $getRecord->slug) }}" placeholder="Category Slug" class="form-control mt-2">
                                    ...
                                    <button class="btn btn-md btn-info mt-3" type="submit">Update Category</button>
                                </form>
                            </div>
                        </div>
                    </div>
