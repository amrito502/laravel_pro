                            ...
                            <div class="card-body p-3">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Category Name" class="form-control mt-2">
                                    </div>

                                    <div class="form-group mb-2">
                                        <label for="name">Slug <span class="text-danger">*</span></label>
                                        <input type="text" name="slug" value="{{ old('slug') }}" placeholder="Category Slug" class="form-control mt-2">
                                    ...
                                    <button class="btn btn-md btn-info mt-3" type="submit">Add Category</button>
                                </form>
                            </div>
                        </div>
                    </div>
